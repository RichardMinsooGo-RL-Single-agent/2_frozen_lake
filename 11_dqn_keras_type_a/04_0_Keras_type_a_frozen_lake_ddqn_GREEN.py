...
class DQN_agent:
    ...
    def train_model(self):
        ...
        states = states.reshape(self.batch_size,n_rows,n_cols,1)
        next_states = next_states.reshape(self.batch_size,n_rows,n_cols,1)
    ...
    def save_model(self):
        ...
        self.model.save_weights(model_path+"/Model_ddqn_0.h5")
...
def main():
    ...
    if os.path.isfile(model_path+"/Model_ddqn_0.h5"):
        agent.model.load_weights(model_path+"/Model_ddqn_0.h5")
    ...
    pylab.savefig("./save_graph/frozenlake_doubledqn.png")
