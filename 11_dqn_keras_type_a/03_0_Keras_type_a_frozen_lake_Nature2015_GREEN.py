...
class DQN_agent:
    ...
    def save_model(self):
        ...
        self.model.save_weights(model_path+"/Model_nature2015.h5")
...
def main():
    ...
    if os.path.isfile(model_path+"/Model_nature2015.h5"):
        agent.model.load_weights(model_path+"/Model_nature2015.h5")
